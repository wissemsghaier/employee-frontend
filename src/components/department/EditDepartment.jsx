...
//             setDeploading(true)
//             try {
//                 const responnse = await axios.get(`https://employee-api-sepia.vercel.app/api/department/${id}`,{
//                   headers: {
...
//         e.preventDefault();
//         try {
//             const response = await axios.put(`https://employee-api-sepia.vercel.app/api/department/${id}`, department, {
//                 headers: {
//                     Authorization: `Bearer ${localStorage.getItem('token')}`
//                 }
//             });
...
const EditDepartment = () => {
    ...
    useEffect(() => {
        const fetchDepartments = async () => {
            setDeploading(true);
            try {
                const response = await axios.get(`https://employee-api-sepia.vercel.app/api/department/${id}`, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("token")}`
                    }
                });
    ...
    return (
        <>
            {depLoading ? (
                ...
                <div className="max-w-lg mx-auto bg-white shadow-lg rounded-lg p-6 mt-10">
                    <h3 className="text-3xl font-bold text-center text-gray-800 mb-6">Edit Department</h3>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        {/* Department Name */}
                        <div>
                            <label htmlFor="dep_name" className="block text-gray-700 font-semibold mb-1">

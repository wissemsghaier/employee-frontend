        ...
        const fetchLeaves = async () => {
            ...
            try {
                ...
                if (user.role === "employee") {
                    url = `https://employee-api-sepia.vercel.app/api/leave/${user._id}`; // Employé : ses propres congés
                } else if (user.role === "admin" && id) {
                    url = `https://employee-api-sepia.vercel.app/api/leave/${id}`; // Admin : congés d'un employé spécifique
                } else {
                    url = "https://employee-api-sepia.vercel.app/api/leave/"; // Admin : tous les congés
                }
